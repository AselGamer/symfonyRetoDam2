 ...
 * Etiquetavideojuego
 *
 * @ORM\Table(name="EtiquetaVideoJuego", indexes={@ORM\Index(name="EtiquetaVideoJuegoEtiqueta", columns={"idEtiqueta"}), @ORM\Index(name="EtiquetaVideoJuegoVideoJuego", columns={"idVideojuego"})})
 * @ORM\Entity
 */
